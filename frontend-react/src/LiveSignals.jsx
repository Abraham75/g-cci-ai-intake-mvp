...
import { AlertTriangle, Camera, RefreshCw, ShieldCheck, Truck, MapPin } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-3">
        {data.signals.map((s) => <div key={s.id} className="bg-[#0f1f38] border border-slate-800 rounded-xl p-4">
